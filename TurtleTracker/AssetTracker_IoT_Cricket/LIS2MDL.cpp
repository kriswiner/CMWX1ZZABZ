...
void LIS2MDL::init(uint8_t MODR)
{
 ...
 _i2c_bus->writeByte(LIS2MDL_ADDRESS, LIS2MDL_CFG_REG_A, 0x80 | MODR<<2);  // high-resolution mode
 _i2c_bus->writeByte(LIS2MDL_ADDRESS, LIS2MDL_CFG_REG_A, 0x80 | MODR<<2 | 0x10);  // low power mode

 // enable low pass filter (bit 0 == 1), set to ODR/4, enable offset-cancellation bit 1
 _i2c_bus->writeByte(LIS2MDL_ADDRESS, LIS2MDL_CFG_REG_B, 0x03);  
...
void LIS2MDL::selfTest()
{
 ...
 _i2c_bus->writeByte(LIS2MDL_ADDRESS, LIS2MDL_CFG_REG_A, 0x80);  
 _i2c_bus->writeByte(LIS2MDL_ADDRESS, LIS2MDL_CFG_REG_B, 0x02);  
