...
// writeByte(BMA400_ADDRESS,BMA400_AUTOLOWPOW_1, 0x04);             // switch to low power after time out (max 10.2 sec)
   ...
   writeByte(BMA400_ADDRESS,BMA400_INT1_MAP, 0x04);              // map WKUP interrupt to INT1 (bit 0) 
   writeByte(BMA400_ADDRESS,BMA400_INT2_MAP, 0x01);              // map GEN1 interrupt to INT2 (bit 2)
