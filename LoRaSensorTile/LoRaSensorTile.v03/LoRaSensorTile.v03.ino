...
//const char *devEui = "9473730323239374";

//Barry's LoRaSensorTile
const char *appEui = "70B3D57ED0009B8E";
const char *appKey = "8599E8839983295591138009D8A0AFBD";
const char *devEui = "0079CFCBC76D9FC0";
...
//    RTC.enableAlarm(RTC.MATCH_ANY); // alarm once a second
   ...
   */
    ...
    LoRaTimer.start(callbackLoRaTx,  60000, 600000);  // 10 minute period
//    DataTimer.start(callbackData,       0,  60000); //  1 minute period
