...
void BMA280::initBMA280(uint8_t Ascale, uint8_t BW, uint8_t power_Mode, uint8_t sleep_dur)
{
   ...
   writeByte(BMA280_ADDRESS,BMA280_PMU_LOW_POWER, 0x20);       // use time-based wake/sleep cycling for low power mode 1
...
void BMA280::fastCompensationBMA280()
{
     ...
     writeByte(BMA280_ADDRESS,BMA280_OFC_SETTING, 0x40 | 0x01); // set target data to 0g, 0g, and -1 g, cutoff at 1% of bandwidth
